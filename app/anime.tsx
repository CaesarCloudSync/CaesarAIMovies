        ...
        <View style={{flex:1,backgroundColor:"#141212"}}>
            ...
            <View style={{flex:0.13,justifyContent:"center",alignItems:"center",flexDirection:"column",gap:30}}>
                    ...
                    <View style={{flexDirection:"row",gap:10}}>
                        <TouchableOpacity onPress={() =>{router.push("/anime")}} ><Text style={{color:"white",padding:5}}>Movies</Text></TouchableOpacity>
            ...
            />
            <NavigationFooter style={{flex:0.1}} currentpage={"home"} mediatype={"anime"}/>
